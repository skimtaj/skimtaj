...
| **Auth**        | ![JWT](https://img.shields.io/badge/-JWT-blueviolet?style=flat-square&logo=json-web-tokens) ![bcrypt](https://img.shields.io/badge/-bcrypt-darkgreen?style=flat-square) |
...
✅ Built REST APIs integrated with frontend frameworks  
🔄 Currently exploring React and Next.js  
🌐 Interested in cloud deployment & CI/CD pipelines  
...
🚀 Stay tuned! Some amazing open-source Node.js projects are on their way.
